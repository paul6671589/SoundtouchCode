...
#define TEST_FLOAT_EQUAL(a, b)  (abs(a - b) < 1e-10)
...
void SoundTouch::putSamples(const SAMPLETYPE *samples, uint nSamples)
{
    ...
    */
	...
	// paul add
	pBPMDetector->inputSamples(samples, nSamples);
}
...
// paul add
void SoundTouch::initialBPM()
{
	pBPMDetector = new BPMDetect(channels, samplerate);
}

float SoundTouch::getBPM()
{
	if (!pBPMDetector)
	{
		return 0.001f;
